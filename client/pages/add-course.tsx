  ...
  return (
    <Page>
      <Page.Content>
        <h2>Add Course</h2>
        <Spacer h={2} />
        <Text b font="30px">Course Title: Service Innovation</Text> 
        <Grid.Container  justify="center" gap={3} height="100%">
          <Grid flex-direction="column" direction="column" xs={24} md={12}>
                <Image height="fluid" src="https://www.bain.com/contentassets/100cd05b7a634f839e25e66cde37850e/gettyimages-1178687233-16_9.jpg" />
          </Grid>
