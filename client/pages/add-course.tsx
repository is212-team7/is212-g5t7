    ...
    <Page>
      <Page.Content>
        ...
        <Grid.Container justify="center" gap={3} height="100%">
          <Grid flex-direction="column" direction="column" xs={24} md={12}>
            <Image
              height="fluid"
          ...
          <Grid direction="column" xs={24} md={12}>
            ...
            <Spacer />
            <Text>
              This module covers knowledge and application skills in
              understanding the importance of service innovation and the methods
              and opportunities that are available for a service staff to
              generate ideas that contribute to service innovation.
            </Text>
            <Spacer />
