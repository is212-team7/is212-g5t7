...
export const skillCategories: SkillCategory = {
  sales: [
    ...
    { label: 'Customer Needs Analysis', description: 'Description is empty.' },
  ...
  marketing: [
    ...
    { label: 'Sales Funnel Management', description: 'Description is empty.' },
    { label: 'CMS Tools', description: 'Description is empty.' },
    { label: 'Graphic Design Skills', description: 'Description is empty.' },
    { label: 'Email Marketing Skills', description: 'Description is empty.' },
    ...
    { label: 'Photography and Branding', description: 'Description is empty.' },
  ],
  admin: [
